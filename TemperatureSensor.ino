...
void initTemperatureSensors(){
  pinMode(SOLAR_RECEIVER_TEMPERATURE_SENSOR_PIN_CS, OUTPUT);
  pinMode(SOLAR_RECEIVER_TEMPERATURE_SENSOR_PIN_SO, INPUT);
  pinMode(SOLAR_RECEIVER_TEMPERATURE_SENSOR_PIN_SCK, OUTPUT);
}
